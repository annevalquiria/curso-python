...
frame_visor = tk.Frame(janela, width = 240, height = 50, bg = PC.CorBranco) #Criei o widget
frame_visor.grid(row = 0, column = 0) #Insere o frame usando grid

#Criacao do frame botoes 
frame_botoes = tk.Frame(janela, width = 500, height = 270, bg = PC.CorCinzaEscuro)
...
#Linha 5
Botao_21 = tk.Button(frame_botoes, text = "0", width = 4, height = 2)
Botao_21.place(x=0, y=52*4)
Botao_22 = tk.Button(frame_botoes, text = "00", width = 4, height = 2)
Botao_22.place(x=60, y=52*4)
Botao_23 = tk.Button(frame_botoes, text = ".", width = 4, height = 2)
Botao_23.place(x=120, y=52*4)
Botao_24 = tk.Button(frame_botoes, text = "^", width = 4, height = 2)
Botao_24.place(x=180, y=52*4)
