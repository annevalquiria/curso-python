...
Botao_13 = tk.Button(frame_botoes, text = "div", width = 4, height = 2, bg = PC.CorRosa, command = lambda:_command_tecla("/"))
...
Botao_24=tk.Button(frame_botoes, text = '*', width = 4, height= 2, bg = PC.CorRosa, command = lambda:_command_tecla("*")).place(x=180, y=52)
...
Botao_34=tk.Button(frame_botoes, text = '-', width = 4, height= 2, bg = PC.CorRosa, command = lambda:_command_tecla("-")).place(x=180, y=52*2)
...
Botao_44=tk.Button(frame_botoes, text = '+', width = 4, height= 2, bg = PC.CorRosa, command = lambda:_command_tecla("+")).place(x=180, y=52*3)
...
Botao_54=tk.Button(frame_botoes, text = '^', width = 4, height= 2, bg = PC.CorRosa, command = lambda:_command_tecla("**")).place(x=180, y=52*4)
